...
use entities::users::{self, Entity as User};
...
impl UserService {
    ...
    pub async fn create_user(&self, email: String, first_name: String, last_name: String, password: String) -> Result<Option<users::Model>, DbErr> {
